...
<img className="block" src="https://github.com/chmouel/raffi/assets/98980/04d6af0f-2a80-47d5-a2ec-95443a629305" alt="Raffi launcher screenshot" />
...
<AccordionGroup>
  ...
  <Accordion title="Window Manager Integration">
...
<CardGroup cols={2}>
  <Card title="Install Raffi" icon="download" href="/installation">
