...
<ParamField path="-c, --configfile" type="string" default="~/.config/raffi/raffi.yaml">
...
<ParamField path="-u, --ui-type" type="string" default="fuzzel">
...
<ParamField path="-I, --no-icons" type="boolean" default="false">
...
<ParamField path="-i, --initial-query" type="string">
...
<ParamField path="-t, --theme" type="string" default="dark">
...
<ParamField path="-p, --print-only" type="boolean" default="false">
...
<ParamField path="-P, --default-script-shell" type="string" default="bash">
...
<ParamField path="-r, --refresh-cache" type="boolean" default="false">
